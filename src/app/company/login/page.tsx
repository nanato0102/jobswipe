...
import { LogIn, AlertCircle, Building2, Zap } from "lucide-react";
              ...
              >
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="hr@company.jp"
                    className="w-full text-xs sm:text-sm border border-slate-300 rounded-xl px-3.5 py-2.5 text-slate-900 focus:outline-none focus:ring-2 focus:ring-slate-900"
                  />
                </div>
                <div className="pt-2 flex gap-2">
                  ...
                  <button
                    type="submit"
                    className="flex-1 py-2.5 bg-slate-900 hover:bg-slate-800 text-white rounded-xl text-xs font-bold transition-colors shadow-xs cursor-pointer"
                  >
                    送信する
                  </button>
                </div>
