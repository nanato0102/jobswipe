              ...
              >
                <div>
                  <div className="flex items-start justify-between mb-3 gap-2">
                    <div className="flex items-center gap-3">
                      {(() => {
                        ...
                        return (
                          <div
                            className={`w-11 h-11 rounded-xl flex items-center justify-center shadow-2xs flex-shrink-0 text-white border border-white/20 ${
                  ...
                  <div className="mb-3">
                    <Link
                      href={`/students/${student.studentId}`}
                      className="text-xs font-semibold text-slate-700 hover:text-emerald-800 block mb-1 truncate"
                    >
                ...
                <div className="pt-3 border-t border-slate-100 flex items-center gap-2">
                  <Link
                    href={`/students/${student.studentId}`}
                    className="flex-1 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-bold rounded-xl flex items-center justify-center transition-colors text-center"
                  >
                    詳細・動画
                  </Link>
                  <button
                    onClick={() => setSelectedStudent(student)}
                    className="flex-1 py-2.5 bg-emerald-700 hover:bg-emerald-600 text-white text-xs font-semibold rounded-xl flex items-center justify-center gap-1.5 transition-colors shadow-sm"
                  >
