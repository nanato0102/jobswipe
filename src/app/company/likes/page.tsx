      ...
      <CompanyMobileTabs>
        <div className="max-w-4xl mx-auto px-4 py-6 sm:py-8 space-y-6 w-full">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="space-y-1">
              <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-md text-xs font-semibold bg-blue-50 text-blue-900 border border-blue-200">
            ...
            <Link
              href="/swipe"
              className="px-4 py-2 bg-slate-900 hover:bg-slate-800 text-white rounded-md text-sm font-semibold transition-all shadow-xs flex items-center gap-1.5 self-start sm:self-auto"
            >
          ...
          {likes.length === 0 ? (
            <div className="bg-white p-8 sm:p-12 rounded-xl border border-slate-200/90 text-center text-slate-500 text-sm shadow-xs space-y-4">
              <div className="w-12 h-12 rounded-lg bg-rose-50 text-rose-500 flex items-center justify-center mx-auto border border-rose-200">
              ...
              <div className="pt-2">
                <Link
                  href="/swipe"
                  className="inline-flex items-center gap-2 px-5 py-2.5 bg-slate-900 hover:bg-slate-800 text-white rounded-md text-sm font-semibold transition-all shadow-xs"
                >
                ...
                return (
                  ...
                  >
                    <div className="flex items-start justify-between gap-3">
                      <div className="flex items-center gap-3.5">
                        ...
                        <div className="flex-shrink-0">
                          {avatarUrl ? (
                            <div className="w-12 h-12 rounded-lg overflow-hidden border border-slate-200 shadow-2xs bg-slate-100">
                              {/* eslint-disable-next-line @next/next/no-img-element */}
                              <img src={avatarUrl} alt={item.studentName} className="w-full h-full object-cover" />
                            </div>
                          ) : (
                            <div
                              className={`w-12 h-12 rounded-lg flex flex-col items-center justify-center shadow-2xs text-white border border-white/40 ${
                        ...
                        <div className="space-y-0.5">
                          ...
                          >
                            ...
                            <span className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded-md bg-slate-100 text-slate-600 border border-slate-200 text-xs font-semibold">
                              <Lock className="w-3 h-3 text-slate-500" />
                              <span>承諾後開示</span>
                            </span>
                            <span className="text-xs font-normal text-blue-700 opacity-0 group-hover:opacity-100 transition-opacity">
                              (プロフィール →)
                            </span>
                          </Link>
                          <p className="text-xs sm:text-sm text-slate-500">{item.university}</p>
                        </div>
                      </div>

                      <span className="text-xs px-2.5 py-1 rounded-md font-semibold bg-rose-50 text-rose-700 border border-rose-200 flex items-center gap-1 shadow-2xs">
                    ...
                    <div className="p-3 bg-slate-50 border border-slate-200 rounded-md space-y-0.5">
                      <span className="text-xs font-semibold text-slate-400 block">自己PR動画タイトル</span>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pt-2 border-t border-slate-100">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          ...
                          className="px-4 py-1.5 bg-slate-900 hover:bg-slate-800 text-white rounded-md text-xs font-semibold transition-all shadow-xs flex items-center gap-1.5 cursor-pointer"
                        >
        ...
        {selectedStudent && (
          <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-xs flex items-center justify-center p-4">
            <div className="bg-white rounded-xl p-6 sm:p-7 max-w-lg w-full shadow-2xl border border-slate-200 animate-scale-up space-y-4">
              ...
              {sentSuccess ? (
                <div className="py-8 text-center space-y-3">
                  ...
                  <p className="text-sm text-slate-500">学生が承諾すると本名が開示され、チャット面談が開始されます。</p>
                </div>
              ) : (
                <div className="space-y-4">
                  <div className="space-y-1.5">
                    ...
                    <textarea
                      ...
                      className="w-full p-3 bg-slate-50 border border-slate-200 rounded-md text-sm text-slate-800 focus:bg-white focus:outline-none focus:ring-2 focus:ring-slate-900 focus:border-slate-900 leading-relaxed"
                    />
                  </div>
                  ...
                  <div className="flex gap-2.5 pt-2">
                    ...
                    <button
                      ...
                      className="flex-1 py-2.5 bg-slate-900 hover:bg-slate-800 text-white rounded-md text-sm font-semibold transition-all shadow-xs flex items-center justify-center gap-1.5 cursor-pointer disabled:opacity-50"
                    >
