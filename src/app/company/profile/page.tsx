        ...
        <div className="max-w-4xl mx-auto px-4 py-6 sm:py-8 space-y-6 w-full">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <button
              ...
              disabled={loading}
              className="px-5 py-2 rounded-md bg-slate-900 hover:bg-slate-800 text-white text-sm font-semibold transition-all shadow-xs flex items-center gap-1.5 disabled:opacity-50 cursor-pointer self-start sm:self-auto"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-white rounded-xl border border-slate-200/90 shadow-sm p-5 sm:p-6 space-y-5">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-5">
                <div className="flex-shrink-0">
                  {logoUrl ? (
                    <div className="w-20 h-20 rounded-lg overflow-hidden border-2 border-slate-200 shadow-2xs bg-white flex items-center justify-center p-2">
                      {/* eslint-disable-next-line @next/next/no-img-element */}
                      <img src={logoUrl} alt="自社ロゴ" className="max-w-full max-h-full object-contain" />
                    </div>
                  ) : (
                    <div className="w-20 h-20 rounded-lg bg-slate-900 text-emerald-400 font-bold text-xl flex items-center justify-center shadow-xs">
                ...
                <div className="space-y-2 flex-1">
                  <div>
                    <p className="text-sm font-bold text-slate-900">企業ロゴ画像（正方形推奨）</p>
            ...
            <div className="bg-white rounded-xl border border-slate-200/90 shadow-sm p-5 sm:p-6 space-y-4">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                <div className="space-y-1.5">
                  <label className="block text-sm font-semibold text-slate-700">代表者氏名</label>
                  <input
                    type="text"
                ...
                <div className="space-y-1.5">
                  <label className="block text-sm font-semibold text-slate-700">従業員数</label>
                  <input
                    type="text"
                ...
                <div className="sm:col-span-2 space-y-1.5">
                  <label className="block text-sm font-semibold text-slate-700">本社所在地</label>
                  <input
                    type="text"
                    value={location}
                ...
                <div className="sm:col-span-2 space-y-1.5">
                  <label className="block text-sm font-semibold text-slate-700">企業公式WebサイトURL</label>
                  <input
                    type="url"
                    value={websiteUrl}
            ...
            <div className="bg-white rounded-xl border border-slate-200/90 shadow-sm p-5 sm:p-6 space-y-4">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-1.5">
                  <label className="block text-sm font-semibold text-slate-700">求める人物像（人柄・スタンス）</label>
                  <textarea
                    rows={3}
                ...
                <div className="space-y-1.5">
                  <label className="block text-sm font-semibold text-slate-700">福利厚生・働く環境（カンマ区切り）</label>
                  <input
                    type="text"
                    value={benefits}
            ...
            <div className="flex items-center justify-end pt-2">
              <button
                type="submit"
                disabled={loading}
                className="w-full sm:w-auto px-8 py-2.5 bg-slate-900 hover:bg-slate-800 text-white rounded-md text-sm font-semibold shadow-xs transition-all flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
              >
                <Save className="w-4 h-4" />
                <span>{loading ? "保存中..." : "変更を保存する"}</span>
              </button>
