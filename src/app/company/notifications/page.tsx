              ...
              filteredNotifications.map((item) => (
                <div
                  ...
                  className={`p-4 sm:p-5 rounded-2xl border transition-all cursor-pointer flex items-start justify-between gap-4 group ${
                    !item.isRead
                      ? "bg-white border-blue-300 shadow-xs hover:border-blue-500 hover:shadow-md"
                ...
                >
                  <div className="flex items-start gap-3.5 min-w-0">
                    ...
                    <div className="space-y-1 min-w-0">
                      ...
                      <div className="flex items-center gap-3 pt-1 text-[11px] text-slate-400">
                        ...
                        {!item.isRead ? (
                          <span className="font-bold text-blue-800">未読</span>
                        ) : (
                          <span>既読</span>
                        )}
                      </div>
                  ...
                  <ChevronRight className="w-4 h-4 text-slate-400 group-hover:text-blue-700 group-hover:translate-x-0.5 transition-all flex-shrink-0 mt-3" />
                </div>
              ))
            )}
          </div>
