...
import { ShieldCheck, Users, Building2, Film, Send, Trash2, CheckCircle } from "lucide-react";
        ...
        <div className="mb-6 flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-1">
              プラットフォーム全体のKPI状況と投稿コンテンツの監視（管理者専用）
            </p>
          </div>

          <span className="text-xs bg-rose-600 text-white px-3 py-1.5 rounded-lg font-bold">
            管理者権限
          </span>
        </div>
