...
export default function HomePage() {
  ...
  return (
    <div className="flex-1 flex flex-col min-h-screen bg-white text-slate-900 overflow-x-hidden">
      {/* ========================================================================= */}
      {/* 1. ヒーローセクション（白基調 ＋ シャープなモック ＆ 端正なタイポグラフィ） */}
      {/* ========================================================================= */}
      <section className="relative overflow-hidden pt-10 pb-16 sm:pt-16 sm:pb-24 lg:pt-20 lg:pb-28 bg-white border-b border-slate-200">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
              <FadeInView>
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-md bg-slate-100 border border-slate-200 text-slate-800 text-xs sm:text-sm font-semibold">
                  <Sparkles className="h-3.5 w-3.5 text-emerald-700 flex-shrink-0" />
                  <span>新世代の動画逆求人プラットフォーム</span>
                </div>
              </FadeInView>
              ...
              <FadeInView delay={300}>
                <div className="pt-2 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3 sm:gap-4">
                  <Link
                    href="/register"
                    className="w-full sm:w-auto px-7 py-3.5 rounded-lg bg-emerald-700 hover:bg-emerald-600 text-white font-bold text-sm shadow-xs transition-colors flex items-center justify-center gap-2 cursor-pointer"
                  >
                ...
                <div className="pt-4 flex flex-wrap items-center justify-center lg:justify-start gap-y-2 gap-x-5 text-xs text-slate-600 font-medium">
                  ...
                  <span className="flex items-center gap-1.5">
                    <Lock className="w-3.5 h-3.5 text-emerald-700 stroke-[2.5]" />
                    <span>承諾まで本名非公開（イニシャル表示）</span>
                  </span>
                  <span className="flex items-center gap-1.5">
                    <RotateCcw className="w-3.5 h-3.5 text-emerald-700 stroke-[2.5]" />
                    <span>何度でも撮り直し可能</span>
                  </span>
                  <span className="flex items-center gap-1.5">
                    <FileText className="w-3.5 h-3.5 text-emerald-700 stroke-[2.5]" />
                ...
                {/* 企業担当者向け専用導線 */}
                <div className="pt-3 text-xs text-slate-500 flex items-center justify-center lg:justify-start gap-1.5 font-medium">
            ...
            {/* 右側：スワイプ画面の実物スマートフォンモックアップ（端正なフレーム） */}
                ...
                <div className="relative w-full max-w-[280px] sm:max-w-[310px] aspect-[9/18] rounded-2xl bg-slate-950 p-2 shadow-lg border-2 border-slate-300">
                  <div className="relative w-full h-full rounded-xl overflow-hidden bg-slate-900 flex flex-col justify-between p-4 text-white">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="px-2 py-0.5 rounded bg-emerald-700 text-[10px] font-bold">LIVE</span>
                    </div>
                    ...
                    <div className="flex flex-col items-center justify-center space-y-3 my-auto">
                      ...
                      <div className="flex items-center gap-1 h-5">
                        ...
                        <span className="w-1 h-5 bg-emerald-400 rounded-full animate-pulse delay-200" />
                        <span className="w-1 h-3.5 bg-emerald-500 rounded-full animate-pulse delay-100" />
                        <span className="w-1 h-2 bg-emerald-500 rounded-full animate-pulse" />
                      </div>
                    ...
                    <div className="space-y-2">
                      <div className="bg-slate-800/90 p-2.5 rounded-lg border border-slate-700">
                        <div className="flex items-center gap-1.5 flex-wrap">
                          ...
                          <span className="text-[10px] text-emerald-400 font-medium">情報科学専攻 (27卒)</span>
                        </div>
                      ...
                      <div className="flex items-center justify-between pt-1 gap-2">
                        ...
                        <div className="flex-1 py-1.5 rounded-md bg-emerald-700 text-white text-[11px] font-medium flex items-center justify-center gap-1">
      ...
      {/* ========================================================================= */}
      {/* 2. 【対比構造】従来の就活 vs JobSwipeによる解決（端正なエディトリアル形式） */}
      {/* ========================================================================= */}
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <FadeInView delay={100}>
              <div className="bg-white rounded-xl border border-slate-200 p-6 space-y-4 shadow-xs h-full flex flex-col justify-between">
                ...
                <div className="p-3.5 bg-white rounded-lg border-l-2 border-emerald-600 border border-slate-200 space-y-1">
      ...
      {/* ========================================================================= */}
      {/* 3. 「学生 ＆ 企業 メリット」タブ切り替え (id="features") */}
      {/* ========================================================================= */}
      <section id="features" className="py-16 sm:py-24 bg-white scroll-mt-16 border-b border-slate-200">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
          ...
          {/* 切り替えタブボタン（端正なセグメントUI） */}
          <div className="flex justify-center">
            <div className="inline-flex p-1 bg-slate-100 rounded-lg border border-slate-200 gap-1">
              <button
                type="button"
                onClick={() => setActiveTab("student")}
                className={`px-4 py-2 rounded-md text-xs sm:text-sm font-bold transition-all flex items-center gap-2 cursor-pointer ${
                  activeTab === "student"
          ...
          {activeTab === "student" ? (
            ...
            <div className="grid sm:grid-cols-3 gap-6 animate-fade-in">
              <div className="bg-white rounded-xl border border-slate-200 p-6 space-y-3 text-center flex flex-col items-center justify-between shadow-xs">
                <div className="space-y-2.5 flex flex-col items-center">
                  <div className="w-8 h-8 rounded-md bg-slate-100 text-slate-800 border border-slate-200 flex items-center justify-center font-black text-xs mx-auto">
                    01
                  </div>
                  <h3 className="font-bold text-slate-900 text-sm sm:text-base">ESや学歴で落とされない</h3>
              ...
              <div className="bg-white rounded-xl border border-slate-200 p-6 space-y-3 text-center flex flex-col items-center justify-between shadow-xs">
                <div className="space-y-2.5 flex flex-col items-center">
                  ...
                  <h3 className="font-bold text-slate-900 text-sm sm:text-base">動画1本を投稿して待つだけ</h3>
                  <p className="text-xs text-slate-600 leading-relaxed font-normal">
              ...
              <div className="bg-white rounded-xl border border-slate-200 p-6 space-y-3 text-center flex flex-col items-center justify-between shadow-xs">
                <div className="space-y-2.5 flex flex-col items-center">
                  ...
                  <h3 className="font-bold text-slate-900 text-sm sm:text-base">社風の合う企業からオファー</h3>
                  <p className="text-xs text-slate-600 leading-relaxed font-normal">
            ...
            <div className="grid sm:grid-cols-3 gap-6 animate-fade-in">
              <div className="bg-white rounded-xl border border-slate-200 p-6 space-y-3 text-center flex flex-col items-center justify-between shadow-xs">
                <div className="space-y-2.5 flex flex-col items-center">
                  ...
                  <h3 className="font-bold text-slate-900 text-sm sm:text-base">面接前のミスマッチを削減</h3>
                  <p className="text-xs text-slate-600 leading-relaxed font-normal">
              ...
              <div className="bg-white rounded-xl border border-slate-200 p-6 space-y-3 text-center flex flex-col items-center justify-between shadow-xs">
                <div className="space-y-2.5 flex flex-col items-center">
                  ...
                  <h3 className="font-bold text-slate-900 text-sm sm:text-base">スワイプで直感スカウト</h3>
                  <p className="text-xs text-slate-600 leading-relaxed font-normal">
              ...
              <div className="bg-white rounded-xl border border-slate-200 p-6 space-y-3 text-center flex flex-col items-center justify-between shadow-xs">
                <div className="space-y-2.5 flex flex-col items-center">
                  ...
                  <h3 className="font-bold text-slate-900 text-sm sm:text-base">人柄重視の効率的な採用</h3>
                  <p className="text-xs text-slate-600 leading-relaxed font-normal">
      ...
      <section id="how-it-works" className="py-16 sm:py-24 bg-slate-50 border-b border-slate-200 scroll-mt-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            {/* STEP 1 */}
            <FadeInView delay={100}>
              <div className="bg-white rounded-xl border border-slate-200 shadow-xs p-6 space-y-4 relative h-full flex flex-col items-center text-center justify-between">
                <div className="space-y-3 flex flex-col items-center">
                  <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-md bg-slate-100 text-slate-800 border border-slate-200 text-xs font-bold">
                ...
                <div className="pt-3 border-t border-slate-100 w-full space-y-1.5 text-[11px] text-slate-600 font-medium text-left max-w-[240px] mx-auto">
            ...
            <FadeInView delay={200}>
              <div className="bg-white rounded-xl border border-slate-200 shadow-xs p-6 space-y-4 relative h-full flex flex-col items-center text-center justify-between">
                ...
                <div className="pt-3 border-t border-slate-100 w-full text-[11px] text-slate-500 text-center font-medium">
                  <span className="font-bold text-slate-700">安心の非公開管理</span>
                  <p className="text-[10px] text-slate-400 mt-0.5 font-normal">法人審査済みの採用担当者のみ閲覧</p>
                </div>
              </div>
            </FadeInView>
            ...
            <FadeInView delay={300}>
              <div className="bg-white rounded-xl border border-slate-200 shadow-xs p-6 space-y-4 relative h-full flex flex-col items-center text-center justify-between">
                ...
                <div className="pt-3 border-t border-slate-100 w-full text-[11px] text-slate-500 text-center font-medium">
                  ...
                  <p className="text-[10px] text-slate-400 mt-0.5 font-normal">事前の雰囲気確認で高マッチ率</p>
                </div>
              </div>
            </FadeInView>
          </div>
      ...
      {/* ========================================================================= */}
      {/* 5. 人柄・内面が可視化される4大要素セクション（落ち着いたモノトーン・グリッド） */}
      {/* ========================================================================= */}
      <section className="py-16 sm:py-24 bg-white border-b border-slate-200">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            <div className="bg-white p-5 rounded-xl border border-slate-200 space-y-3 text-center flex flex-col items-center justify-between shadow-xs">
              <div className="space-y-2.5 flex flex-col items-center">
            ...
            <div className="flex overflow-hidden select-none [mask-image:linear-gradient(to_right,transparent,black_10%,black_90%,transparent)]">
              <div className="animate-marquee gap-2.5 flex">
                {[...targetIndustriesRow1, ...targetIndustriesRow1, ...targetIndustriesRow1].map((ind, idx) => (
                  <div
                    key={idx}
                    className="px-3.5 py-2 bg-white text-slate-800 text-xs sm:text-sm font-semibold rounded-md border border-slate-200 shadow-xs whitespace-nowrap flex items-center gap-2 hover:border-slate-400 transition-colors"
                  >
                  ...
                  {isOpen && (
                    <div className="px-4 sm:px-4.5 pb-4 pt-3 border-t border-slate-100 bg-slate-50/60">
                      <div className="flex items-start gap-3">
                        <span className="w-5 h-5 rounded bg-emerald-700 text-white text-[11px] font-black flex items-center justify-center flex-shrink-0 mt-0.5">
                          A
                        </span>
      ...
      <section className="py-16 sm:py-24 bg-slate-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8">
          <FadeInView>
            <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-8 sm:p-12 space-y-6">
              ...
              <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-4 max-w-md mx-auto">
                <Link
                  href="/register"
                  className="w-full py-3.5 bg-emerald-700 hover:bg-emerald-600 text-white rounded-lg text-sm font-bold transition-colors shadow-xs flex items-center justify-center gap-2 cursor-pointer"
                >
                  <User className="w-4 h-4" />
              ...
              <div className="flex flex-wrap items-center justify-center gap-x-5 gap-y-1.5 text-xs text-slate-500 font-medium pt-2">
                <span>✓ 撮り直し自由</span>
