...
export const appStore = {
  ...
  getStudentDetails: (studentId: string): StudentDetail => {
    ...
    const students: Record<string, StudentDetail> = {
      ...
      s4: {
        ...
        avatarText: "渡",
        avatarUrl: savedAvatar,
        catchphrase: "AI画像解析アルゴリズムの研究とハッカソン最優秀賞。論理的課題解決が得意です。",
        ...
        videoTitle: "AI画像解析アルゴリズムの研究とハッカソン挑戦",
        videoViews: 110,
        videoLikes: 32,
      },
      s5: {
        ...
        avatarText: "鈴",
        avatarUrl: savedAvatar,
        catchphrase: "日商簿記1級。フィンテック企業での財務データ分析と業務自動化を経験。",
        ...
        videoTitle: "財務データ分析と業務自動化プロジェクト",
        videoViews: 85,
        videoLikes: 24,
      },
      s6: {
        ...
        avatarText: "小",
        avatarUrl: savedAvatar,
        catchphrase: "使う人に寄り添うUI/UXデザイン。地域コミュニティアプリの画面設計を担当。",
        ...
        videoTitle: "使う人に寄り添うUI/UXデザインとプロトタイピング",
        videoViews: 68,
        videoLikes: 21,
      },
    };
  ...
  // デモ動画リスト取得（スワイプ画面用・DB未接続時フォールバック）
  getDemoVideos: (): VideoData[] => {
    return [
      {
        id: "v-s1",
        studentId: "s1",
