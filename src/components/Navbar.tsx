          ...
          {isLoggedIn ? (
            <>
              ...
              <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center gap-2 pointer-events-none select-none">
                ...
                <span className="font-bold text-lg text-slate-900 tracking-tight">JobSwipe</span>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-slate-800 font-bold max-w-[120px] sm:max-w-[160px] truncate">
